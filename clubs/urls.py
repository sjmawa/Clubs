...
from clubs.views import club_list, club_detail,delete_club, create_club,join_club, add_role,cancel_request, update_club,pending_requests, approve_member,reject_member
urlpatterns = [
